...
<div class="w3-main" style="margin-left:300px">
    ...
    <form action="{{ url('cadastrarProfessor') }}" method="post">
        ...
        <label for="disciplinas">Selecione suas disciplinas</label>
        <div class='checkinput'>
      
            @foreach ($disciplinas as $disciplina)
              <label for='checkid' class='checkboxes'>
              <input id='checkid' type='checkbox' name='disciplinas[]' value='{{$disciplina[0]}}'>{{$disciplina[1]}}</label>
            @endforeach
