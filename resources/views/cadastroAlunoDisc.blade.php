...
<form action="{{ url('cadastrarAlunoDisc') }}" method="POST">
@csrf
...
<label for="disciplina">Selecione a disciplina</label>
      ...
      <select name="disciplina" id="disciplina">
        ...
        <label for="frequencia">Qual a frequência do aluno nessa disciplina?</label>
        <input type='number' name='frequencia' id='frequencia'/>

        <label for="media">Qual a média desse aluno?</label>
