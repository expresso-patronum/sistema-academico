...
<div class="itens">
  ...
  <a href='cadastroAlunoDisc'>Cadastrar Aluno na disciplina</a>
...
<div class="itensForm">
 ...
 <form action="{{ url('perfilAlunoProcurar') }}" method="post">
 @csrf
    <label for="matricula"> Digite a matricula do aluno para ver seu perfil:
