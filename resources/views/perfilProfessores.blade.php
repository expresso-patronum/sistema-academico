...
<div class="itens">
      ...
      <a href='cadastroProfessor'>Cadastrar Professor</a>

</div>

<div class="itens">

  <a href='cadastroDisciplina'>Cadastrar disciplina</a>
...
<form action="{{ url('perfilProfessor') }}" method="post">
 @csrf
    <label for="professor"> Digite o nome do professor para ver suas disciplinas e alunos:
    <input type = "text" name='professor' /></label>
